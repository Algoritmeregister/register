...
class Algoritmeregister
{
    ...
    {
        return !$id ?
            $this->_transformToIndexed(json_decode(file_get_contents("https://raw.githubusercontent.com/Algoritmeregister/algoritmeregister-metadata-standaard/main/_data/algoritmeregister-metadata-standaard--autogenerated.json"), true)) :
